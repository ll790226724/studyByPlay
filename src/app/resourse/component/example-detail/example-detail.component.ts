 ...
 params = {
    ...
    0 : {//健康风险分类
      ...
      item:{//项目目录
        0:{
          ...
          img:'assets/images/erythema.png',
          locus:{//位点
            rs9937837:{
              // chromosomes:'',
              expound:'正常',
        ...
        1:{
          ...
          img:'assets/images/uric-acid.png',
          locus:{
            rs6449213:{
              expound:'偏高',
              gene:'SLC2A9',
    ...
    2 : {//运动基因分类
      ...
      item:{//项目目录
        0:{
          ...
          img:'assets/images/metabolize.png',
          locus:{//位点
            rs8192678:{
              // chromosomes:'',
              expound:'正常代谢能力',
        ...
        1:{
          ...
          img:'assets/images/endurance.png',
          locus:{
            rs1042713:{
              expound:'运动耐力相对较差',
              gene:'ADRB2',
    ...
    4 : {//罕见遗传病分类
      ...
      item:{//项目目录
        0:{
          ...
          img:'assets/images/dysplasia.png',
          locus:{//位点
            rs132630314:{
              expound:'未携带',
              gene:'EDA',
        ...
        1:{
          ...
          img:'assets/images/deficiency.png',
          locus:{
            rs78950939:{
              expound:'未携带',
              gene:'MPO',
    ...
    5 : {//运动基因分类
      ...
      item:{//项目目录
        0:{
          ...
          img:'assets/images/drug-metabolism.png',
          locus:{//位点
            rs1142345:{
        ...
        1:{
          ...
          img:'assets/images/warfarin.png',
          locus:{
            rs9923231:{
  ...
  ngOnInit() {
    this.activeRouter.queryParams.subscribe(res => {
      ...
      this.searhParams.detId = res.detId;
        ...
        if(this.data[key].id == this.searhParams.id){
          ...
          for(const ke in this.data[key].item){
            if(ke == this.searhParams.detId){
              ...
              console.log(ke,this.searhParams.detId,this.searhParams.id)
      ...
      console.log(this.reportDet.custom)
