...
export class HttpService {
  ...
  //验证密码
  testPwd (params){
    return this.http.post(this.addressService.editPwd( ),this.commonService.mapObjectToParams(params), this.httpOptions)
  }
  //获取检测项目列表
  getitemsLi(){
  ...
  //wxlogin
  getWxloginAddr (params) {
    return this.http.post(this.addressService.WxStr(),  this.commonService.mapObjectToParams(params), this.httpOptions );
  ...
  checkPhone (params) {
    return this.http.get(this.addressService.checkPhone(),{params: params} );
