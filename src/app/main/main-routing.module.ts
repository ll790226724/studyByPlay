...
import { PrivacyProtectionComponent } from '../resourse/component/privacy-protection/privacy-protection.component';
import { PriceProtectionComponent } from '../resourse/component/price-protection/price-protection.component';
import { ServiceAgreementComponent } from '../resourse/component/service-agreement/service-agreement.component';
...
// import {DemoColComponent} from '../demo-col/demo-col.component';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'example/detail/:id', component: TestingDetailComponent},
      ...
      { path: 'PrivacyProtection', component: PrivacyProtectionComponent},
      { path: 'PriceProtection', component: PriceProtectionComponent},
      { path: 'ServiceAgreement', component: ServiceAgreementComponent},
      { path: 'wxLogin', component: WxLoginComponent},
      // { path: 'demo', component: DemoColComponent},
